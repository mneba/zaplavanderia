...
// Verifica se a lavanderia tem plano Pro (ou Trial, que tem todas as features)
app.decorate("requerPro", async (req, reply) => {
  ...
  if (!lav) return reply.status(404).send({ erro: "Lavanderia não encontrada" });
